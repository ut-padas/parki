...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate timings for different G2P algorithmic variants. "
        "Results are saved to `{args.output_dir}/g2p_timing_result_up{args.up}"
