...
# automatically from the template file 'parkipy/ewald/_pk_kernels/templates/_g2p_workunits.py'
...
def g2p_base_fp32(team_member: pk.TeamMember, x):
    ...
    def thread_loop(ii: int):
        ...
        for r in range(window_P):
            if window_P == 14:
                w0[r] = _basic_kaiser_poly_p14_fp32(d0, r)
                w1[r] = _basic_kaiser_poly_p14_fp32(d1, r)
                w2[r] = _basic_kaiser_poly_p14_fp32(d2, r)
            elif window_P == 12:
                w0[r] = _basic_kaiser_poly_p12_fp32(d0, r)
                w1[r] = _basic_kaiser_poly_p12_fp32(d1, r)
                w2[r] = _basic_kaiser_poly_p12_fp32(d2, r)
            elif window_P == 10:
                w0[r] = _basic_kaiser_poly_p10_fp32(d0, r)
                w1[r] = _basic_kaiser_poly_p10_fp32(d1, r)
                w2[r] = _basic_kaiser_poly_p10_fp32(d2, r)
            if window_P == 8:
                w0[r] = _basic_kaiser_poly_p8_fp32(d0, r)
                w1[r] = _basic_kaiser_poly_p8_fp32(d1, r)
                w2[r] = _basic_kaiser_poly_p8_fp32(d2, r)
            elif window_P == 6:
                w0[r] = _basic_kaiser_poly_p6_fp32(d0, r)
                w1[r] = _basic_kaiser_poly_p6_fp32(d1, r)
                w2[r] = _basic_kaiser_poly_p6_fp32(d2, r)
            elif window_P == 4:
                w0[r] = _basic_kaiser_poly_p4_fp32(d0, r)
                w1[r] = _basic_kaiser_poly_p4_fp32(d1, r)
                w2[r] = _basic_kaiser_poly_p4_fp32(d2, r)
            elif window_P == 2:
                w0[r] = _basic_kaiser_poly_p2_fp32(d0, r)
                w1[r] = _basic_kaiser_poly_p2_fp32(d1, r)
                w2[r] = _basic_kaiser_poly_p2_fp32(d2, r)
